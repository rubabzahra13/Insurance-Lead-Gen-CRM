      ...
      enrichLeadFromRawItem(
        {
          ...
          evidence,
          past_experience: raw?.past_experience?.trim() || null,
          fit_evidence: raw?.fit_evidence?.trim() || null,
          fit_source: raw?.fit_source?.trim() || null,
          weak_fields: Array.isArray(raw?.weak_fields) ? raw.weak_fields : [],
